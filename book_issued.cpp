            ...
            if(!in.fail()) {
                ...
                for(int j=0;!in.eof();j++){
                    ...
                    if(Date>=to_date && Date<=from_date && book.borrow_id==ui->lineEdit_borrow_id->text().toInt()) {
                          ...
                          QString issue_date=QString::fromStdString(book.issue_date);
                          QString due_date=QString::fromStdString(book.due_date);
                          ...
                          ui->return_deatils->setItem(i,9,new QTableWidgetItem(issue_date));
                          ui->return_deatils->setItem(i,10,new QTableWidgetItem(due_date));
                          i++;
                          flag=1;
                      }
                      in>>book;
            ...
            if(!in.fail()) {
                ...
                for(int j=0;!in.eof();j++){
                    ...
                    if(Date>=to_date && Date<=from_date && book.borrow_id==ui->lineEdit_borrow_id->text().toInt()) {
                          ...
                          ui->return_deatils->setItem(i,5,new QTableWidgetItem(s_name));
                          ui->return_deatils->setItem(i,6,new QTableWidgetItem(s_dept));
                          ui->return_deatils->setItem(i,7,new QTableWidgetItem(issue_date));
                          ui->return_deatils->setItem(i,8,new QTableWidgetItem(due_date));
                          i++;
                          flag=1;
                      }
                      in>>book;
