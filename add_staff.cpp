...
int  add_staff::verify_data()
{
    int flag=0;
    if(ui->lineEdit_fullname->text().isEmpty()||ui->lineEdit_email->text().isEmpty()||ui->lineEdit_phone->text().isEmpty()||ui->comboBox_exp->currentText()=="Select"||ui->comboBox_dept->currentText()=="Select"||ui->comboBox_qualification->currentText()=="Select")    {
        QMessageBox::information(this,"Warning","please Enter proper data\nPlease Select proper Choice");
        flag=1;
    }
    return flag;
}
