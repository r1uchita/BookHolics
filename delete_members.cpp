...
void delete_members::on_Delete_member_clicked() {
    ...
    if(!ui->lineEdit_borrow_id->hasAcceptableInput()) {
        QMessageBox::warning(this,"Warning","Pls Enter Coreect Borrow Id to Delete");
    }
    else if(ui->members_type->currentText()=="Select"||ui->reasons->currentText()=="Select") {
        if(ui->members_type->currentText()=="Select"){
             QMessageBox::information(this,"Warnning","Please Select proper Member");
        }
        if(ui->reasons->currentText()=="Select"){
            QMessageBox::information(this,"Warnning","Please Select proper reason to delete student");
        }
    }
    else {
        ...
        if(1==check_book_issue(borrow_id)){
                QMessageBox::information(this,"Warning","Member Should Return The Book");
        }
        else{
...
int delete_members::check_book_issue(int id){
    ...
    else if(ui->members_type->currentText()=="Staff"){
